# Self-hosted AI starter kit (Vibe coders)
...
This is taken from Code and added improvements
...
<img src="assets/n8n-demo.gif" width="600" style="border: 1px solid gray;">
...
```
https://github.com/vibecoders1/ai-learning.git
cd ai-learning/self-hosted-ai
...
```
git clone https://github.com/vibecoders1/ai-learning.git
...
- [Guide to the Local AI Starter Kit](https://www.youtube.com/watch?v=bf0Z-WPK6p0&t=60s&ab_channel=vibecoders)
...
I have used below and modified my own way to get all working done.
Credits : cole medin - [Youtube](https://www.youtube.com/results?search_query=call+medina+ai)